...
/// </summary>
public class RebindActionUINew : MonoBehaviour
{
    /// <summary>
    ...
    protected void OnEnable()
    {
        if (s_RebindActionUIs == null)
            s_RebindActionUIs = new List<RebindActionUINew>();
    ...
    private static List<RebindActionUINew> s_RebindActionUIs;
    ...
    [Serializable]
    public class UpdateBindingUIEvent : UnityEvent<RebindActionUINew, string, string, string>
    {
    }

    [Serializable]
    public class InteractiveRebindEvent : UnityEvent<RebindActionUINew, InputActionRebindingExtensions.RebindingOperation>
    {
    }
}
